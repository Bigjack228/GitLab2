...
/**
 * Precompiled gaps.basic.Bigjack228.java-common-conventions script plugin.
 **/
public class GapsBasicBigjack228JavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_GapsBasicBigjack228JavaCommonConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_GapsBasicBigjack228JavaCommonConventions").asSubclass(BasicScript.class);
