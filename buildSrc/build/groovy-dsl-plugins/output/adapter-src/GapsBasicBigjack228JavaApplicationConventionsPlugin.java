...
/**
 * Precompiled gaps.basic.Bigjack228.java-application-conventions script plugin.
 **/
public class GapsBasicBigjack228JavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_GapsBasicBigjack228JavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("gaps.basic.Bigjack228.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_GapsBasicBigjack228JavaApplicationConventions").asSubclass(BasicScript.class);
