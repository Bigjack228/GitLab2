...
/**
 * Precompiled gaps.basic.Bigjack228.java-library-conventions script plugin.
 **/
public class GapsBasicBigjack228JavaLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_GapsBasicBigjack228JavaLibraryConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_GapsBasicBigjack228JavaLibraryConventions").asSubclass(BasicScript.class);
